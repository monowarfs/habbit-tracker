...
Stream<List<MoodLog>> moodLogsForDay(Ref ref, LocalDate day) {
  return ref.watch(moodRepositoryProvider).watchLogsForDay(day);
}
...
Stream<List<MoodLog>> moodLogsInRange(
  ...
  return ref.watch(moodRepositoryProvider).watchLogsInRange(start, end);
}
...
@riverpod
Future<int> moodCurrentStreak(Ref ref) {
