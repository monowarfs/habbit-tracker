...
**Assumption:** implementation run numbers (05-13) referenced here follow the
sequencing proposed in `roadmap.md` (Run 05 = app shell/common, 06 = Water,
07-08 = Medicine, 09-10 = Prayer, 11 = notification hardening, 12 = dashboard/
plugin contract/PIN, 13 = polish/a11y/store prep). Not specified in the input
brief, so proposed here and reused consistently across documents — flag if a
different scheme already exists.
