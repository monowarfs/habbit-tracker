...
| `drift_dev` | 2.34.4 (2026-07-14) | Code generation for Drift tables/DAOs (dev dependency) | Required companion to `drift`, no alternative | Tracks `drift`'s own release cadence exactly |
...
| `intl` | 0.20.3 (2026-06-25) | Locale-aware date/number formatting, Bangla numerals (`localization.md`) | Fixed tech-stack requirement; the official Dart/Flutter internationalization package | Active |
